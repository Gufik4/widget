...
const renderWidget = function(news, checkForNewsOnly) {
    ...
    if (news.length > 0) {
        if (checkForNewsOnly) {
            ...
            // make link to crm
            var _toCMS = $('<div class="wl"><a href="http://news.databridgecmms.com/"> Read <span class="hidden">New</span> News &rarr;</a></div>');
            // make toggler
            var _toggler = $(`<div class="wt"><a>${ICON}</a></div>`);
